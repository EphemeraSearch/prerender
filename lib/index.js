...
// only needed if we don't specify `--remote-debugging-address=::1` when starting chrome
// const dns = require('dns');
// dns.setDefaultResultOrder('ipv4first');  // else chrome will use ipv6 first but it's not supported by the server
