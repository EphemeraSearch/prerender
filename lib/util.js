...
util.warn = function() {
	console.warn.apply(console.warn, [new Date().toISOString()].concat(Array.prototype.slice.call(arguments, 0)));
};

util.error = function() {
	console.error.apply(console.error, [new Date().toISOString()].concat(Array.prototype.slice.call(arguments, 0)));
};
